...
function TabsList({
  ...
  return (
    <TabsPrimitive.List
      className={cn(
        'flex h-12 flex-row items-center justify-center rounded-xl bg-slate-100 dark:bg-neutral-900',
  ...
  return (
    <TextClassContext.Provider
      ...
      <TabsPrimitive.Trigger
        className={cn(
          'flex h-12 flex-row items-center justify-center gap-1.5 rounded-xl border border-transparent px-2 py-1 shadow-none shadow-black/5',
          Platform.select({
          ...
          props.value === value &&
            'bg-popover shadow-lg dark:border-foreground/10 dark:bg-input/30',
          className
        )}
        {...props}
      />
